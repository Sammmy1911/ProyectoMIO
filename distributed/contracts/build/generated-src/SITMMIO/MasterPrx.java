...
{
    default void reportResult(TaskResult result)
    {
        reportResult(result, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void reportResult(TaskResult result, java.util.Map<String, String> context)
    {
        _iceI_reportResultAsync(result, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> reportResultAsync(TaskResult result)
    {
        return _iceI_reportResultAsync(result, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> reportResultAsync(TaskResult result, java.util.Map<String, String> context)
    {
        return _iceI_reportResultAsync(result, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_reportResultAsync(TaskResult iceP_result, java.util.Map<String, String> context, boolean sync)
    {
        ...
        f.invoke(false, context, null, ostr -> {
                     TaskResult.ice_write(ostr, iceP_result);
                 }, null);
        return f;
    }
