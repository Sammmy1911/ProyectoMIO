...
{
    void reportResult(TaskResult result, com.zeroc.Ice.Current current);

    void registerWorker(TaskDispatcherPrx worker, com.zeroc.Ice.Current current);
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_reportResult(Master obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        ...
        TaskResult iceP_result;
        iceP_result = TaskResult.ice_read(istr);
        inS.endReadParams();
        obj.reportResult(iceP_result, current);
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_registerWorker(Master obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
        com.zeroc.Ice.InputStream istr = inS.startReadParams();
        TaskDispatcherPrx iceP_worker;
        iceP_worker = TaskDispatcherPrx.uncheckedCast(istr.readProxy());
        inS.endReadParams();
